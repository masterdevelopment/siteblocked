...
<title>ДОСТУП К ДАННОМУ ИНТЕРНЕТ-РЕСУРСУ ОГРАНИЧЕН</title><meta name="description" content=""><meta name="keywords" content="СП ООО Деловая сеть">
...
<body>
	...
	<tr style="text-align: center">
	<td style="text-align: center">
	<span class="main-title"><b>ДОСТУП К ДАННОМУ ИНТЕРНЕТ-РЕСУРСУ ОГРАНИЧЕН</b></span>
	</td>
	</tr>

	<tr style="text-align: center">
	<td style="text-align: center">
	«Доступ к ресурсу ограничен во исполнение решения Meigo™ Corporation, принятого на основании «Условий пользовательского соглашения».
	<br>Данный сайт будет отключен от серверов в течении месяца, чтобы проинформировать всех посетителей сайта.
	</br>
	<br/>
	</td>
	</tr>
